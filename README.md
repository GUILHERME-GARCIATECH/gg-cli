...
- revisar e melhorar o `.bat` em `portable/`;
- adicionar comando `repo edit`;
- adicionar instalador/empacotamento `.exe`;
- adicionar suporte opcional a TypeScript no futuro.
